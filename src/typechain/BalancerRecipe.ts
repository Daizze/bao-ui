...
export interface BalancerRecipeInterface extends utils.Interface {
  functions: {
...
export interface BalancerRecipe extends BaseContract {
  contractName: "BalancerRecipe";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BalancerRecipeInterface;
